...
// Updated by edouard@lafargue.name to take maximum 2D texture size into account
// for lower-spec'ed GPUs
...
Photosphere.prototype.loadEXIF = function(callback){
	...
	this.loadBinary(function(data){
		...
		if(self.canDoWebGL()){
			...
			// Assumes that the image's width is higher than its height:
